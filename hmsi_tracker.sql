...
--
-- Host: localhost:3306
-- Generation Time: Oct 07, 2025 at 04:27 AM
...
CREATE TABLE `evaluasi` (
  `id_evaluasi` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `komentar` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `komentar_hmsi` text COLLATE utf8mb4_general_ci,
  `pemberi_evaluasi` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status_konfirmasi` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tanggal_evaluasi` date DEFAULT NULL,
  `id_laporan` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL
...
CREATE TABLE `keuangan` (
  `id_keuangan` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `tanggal` date NOT NULL,
  `tipe` enum('Pemasukan','Pengeluaran') COLLATE utf8mb4_general_ci NOT NULL,
  `sumber` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `jumlah` decimal(15,2) NOT NULL,
  `id_laporan` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `id_anggota` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
('51aa409b-e370-49bf-809e-c8f6d4d8535c', '2025-09-25', 'Pengeluaran', 'Pengeluaran dari Laporan: test keuangan', 40000000.00, '13d3095d-0aa7-4207-877c-6c2f123b25ed', '2311522032', '2025-09-25 12:24:10', '2025-09-25 12:24:10'),
...
CREATE TABLE `laporan` (
  `id_laporan` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `judul_laporan` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `deskripsi_kegiatan` varchar(300) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `sasaran` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `waktu_tempat` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `dana_digunakan` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `sumber_dana` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `sumber_dana_lainnya` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `dana_terpakai` decimal(15,2) DEFAULT NULL,
  `persentase_kualitatif` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `persentase_kuantitatif` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `kendala` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `solusi` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `dokumentasi` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `id_ProgramKerja` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `divisi` enum('Internal','Medkraf','Eksternal','Bikraf','PSI','PSDM','RTK') COLLATE utf8mb4_general_ci NOT NULL,
  `tanggal` date DEFAULT NULL,
  `dokumentasi_mime` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
('13d3095d-0aa7-4207-877c-6c2f123b25ed', 'test keuangan', 'kxjzbjkzCBk', '', '09:00-12:00 WIB, gedung C', '40000000', 'Uang Kas HMSI', NULL, 40000000.00, '', '', '', '', NULL, '3ab0989e-9496-11f0-981a-442e1c01b37c', 'Eksternal', '2025-09-25', NULL),
('1995361d-cb7e-4f1c-96fe-cccd89e44b2d', 'AAAAAAAAAAAABbbbbbb', 'akdnkdna', '', '09:00-12:00 WIB, gedung C', '1000000', 'Uang Kas HMSI', NULL, 1000000.00, '', '', '', '', NULL, 'c2518baa-99bc-11f0-999f-6daf25adf4c1', 'Eksternal', '2025-09-25', NULL),
...
('6bed7d89-1030-4fd5-8532-00ce5fbe1b61', 'test pengeluaran ', 'jjkjk', '', '09:00-12:00 WIB, gedung C', '200000', NULL, NULL, 200000.00, '', '', '', '', NULL, '3ab0989e-9496-11f0-981a-442e1c01b37c', 'Eksternal', '2025-09-25', NULL),
...
('d0c6a89d-b659-4104-bfe1-8e2a1a669890', 'AAAAAAAAAAAAAA', 'm m m', '', '09:00-12:00 WIB, gedung C', '100000000000', 'Uang Kas HMSI', NULL, NULL, '', '', '', '', NULL, '279a187d-95eb-11f0-981a-442e1c01b37c', 'Eksternal', '2025-09-25', NULL),
...
CREATE TABLE `notifikasi` (
  `id_notifikasi` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `pesan` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `role` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `divisi` enum('Internal','Medkraf','Eksternal','Bikraf','PSI','PSDM','RTK') COLLATE utf8mb4_general_ci NOT NULL,
  `status_baca` tinyint(1) DEFAULT NULL,
  `id_anggota` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `id_evaluasi` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `id_ProgramKerja` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `id_laporan` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
('1b2cf555-7960-4779-873f-2203ca5d99ef', 'HMSI (PSDM) telah membuat Program Kerja baru: \"Gathering\"', NULL, 'PSDM', 0, NULL, NULL, NULL, NULL, '2025-09-28 12:44:38'),
...
('2c99744f-c6fb-4966-b33a-f67071ca6a76', 'HMSI (PSDM) telah memperbarui Program Kerja: \"Gathering\"', NULL, 'PSDM', 0, NULL, NULL, NULL, NULL, '2025-09-28 12:54:48'),
...
('33baf51c-1b24-43ac-879c-d4a69d3387a6', 'HMSI (PSDM) telah membuat Program Kerja baru: \"SI go to school\"', NULL, 'PSDM', 0, NULL, NULL, 'e74dc123-9c69-11f0-8136-2a6ead1973f5', NULL, '2025-09-28 12:51:51'),
...
('4f219dfd-a141-4ece-81be-68c9eb8e32b2', 'Divisi Eksternal telah menambahkan laporan baru: test keuangan', NULL, 'Internal', 0, NULL, NULL, NULL, '13d3095d-0aa7-4207-877c-6c2f123b25ed', '2025-09-25 12:24:10'),
...
('97abb842-9e6d-46a7-aea9-08f6106b5f52', 'HMSI (PSDM) telah membuat Program Kerja baru: \"SI go to school\"', NULL, 'PSDM', 0, NULL, NULL, NULL, NULL, '2025-09-28 12:20:01'),
...
('cd341fd4-fb9e-43e1-b79c-c1227b44a649', 'HMSI (PSDM) telah memperbarui Program Kerja: \"Gathering\"', NULL, 'PSDM', 0, NULL, NULL, NULL, NULL, '2025-09-28 12:47:50'),
...
CREATE TABLE `program_kerja` (
  `id_ProgramKerja` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `Nama_ProgramKerja` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `Status` enum('Belum Dimulai','Sedang Berjalan','Selesai','Gagal') COLLATE utf8mb4_general_ci DEFAULT 'Belum Dimulai'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
('abc1ba2e-99bc-11f0-999f-6daf25adf4c1', 'test', 'ga ada', '2025-09-26', '2025-09-29', 'Diva', '2311522032', NULL, 'Selesai'),
...
('e74dc123-9c69-11f0-8136-2a6ead1973f5', 'SI go to school', 'ytyt', '2025-09-11', '2025-10-09', 'siska', '2211523019', 'yy.png', 'Sedang Berjalan');
...
CREATE TABLE `user` (
  ...
  `role` enum('Admin','HMSI','DPA') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `divisi` enum('Internal','Medkraf','Eksternal','Bikraf','PSI','PSDM','RTK') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `foto_profile` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `foto_focus` varchar(50) COLLATE utf8mb4_general_ci DEFAULT 'center 50%',
  `theme` enum('light','dark') COLLATE utf8mb4_general_ci DEFAULT 'light'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
('2211523019', 'Niken Khalilah Hamutii', 'psdm@gmail.com', '$2b$10$pb.3/UYsvylE4pp6h3UllOmq8mFybb4KaH/0B5T9mdCEPfAVs3aQq', 'HMSI', 'PSDM', 'uploads/profile/1759061256913-500238954.png', '2025-09-30 00:06:35', 'center 50%', 'light'),
